...
client.on("message",(message) => {
 ...
 if(message.content.startsWith("hi") || message.content.startsWith("hello") || message.content.startsWith("Hi") || message.content.startsWith("Hello") && message.author.id !== 408064561611276290) {
